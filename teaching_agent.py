...
from langchain_ollama import OllamaLLM  # Importation de OllamaLLM
from langchain.llms import BaseLLM
from pydantic import BaseModel, Field

# Pour Llama 3 via Ollama, nous n'avons pas besoin de clé API comme avec OpenAI
# Vérification si le fichier .env existe pour d'autres configurations éventuelles
try:
    ...
    # Vous pourriez stocker d'autres variables d'environnement ici
...
# Initialisation du modèle Llama 3 via OllamaLLM au lieu de ChatOpenAI
